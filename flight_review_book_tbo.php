...
$ab=GetPageRecord('*','wig_flight_json_bkp',' id="'.decode($_REQUEST['r']).'"');
...
$totalcommission = ($res['acom'] + ($resret['acom'] ?? 0));
...
$('#loadonewaytrip').load('flightdetailsbox.php?id=<?php echo $res['id']; ?>&preview=1&tabid=1;');
...
<?php
if (is_array($Baggages) && !empty($Baggages)) {
...
<?php
if (is_array($MealDynamic) && !empty($MealDynamic)) {

if (!empty($MealDynamic) && is_countable($MealDynamic) && count($MealDynamic) > 0) {
...
if (is_array($SeatDynamic) && !empty($SeatDynamic)) {
...
if (is_array($Baggages2) && !empty($Baggages2)) {
...
if (is_array($MealDynamic2) && !empty($MealDynamic2)) {
...
if (is_array($SeatDynamic2) && !empty($SeatDynamic2)) {

if(count($SeatDynamic2)>0){ ?>
...
<div class="col-sm-3 mb-4">
  ...
  <div class="js-form-message">
	...
	<label class="form-label"> Seat </label>
		...
		<a style="line-height: 1.0; max-width:200px;" onClick="loadpop('Select Seat',this,'800px')" data-toggle="modal" data-target=".bs-example-modal-center" popaction="action=selectseat&seatadult=seatChild_<?php echo $child; ?>" class="btn btn-danger border-radius-3 d-flex align-items-center justify-content-center min-height-50 font-weight-bold border-width-2 py-2 w-100 popup-ajax" href="#" >View Seat</a>
...
<input type="hidden" id="seatChildPrice<?php echo $child; ?>" class="seatData" name="seatChildPrice<?php echo $child; ?>" value="0" />

<input type="hidden" id="seatChildCode<?php echo $child; ?>" class="seatData" name="seatChildCode<?php echo $child; ?>" value="" />
...
<input type="hidden" id="seatChildPrice2<?php echo $child; ?>" class="seatData" name="seatChildPrice2<?php echo $child; ?>" value="0" />

<input type="hidden" id="seatChildCode2<?php echo $child; ?>"  class="seatData" name="seatChildCode2<?php echo $child; ?>" value="" />
...
<input name="onewayrefundyes" id="onewayrefundyes" type="hidden" value="<?php echo $onewayrefundyes; ?>">
<input name="roundwayrefundyes" id="roundwayrefundyes" type="hidden" value="<?php echo $roundwayrefundyes; ?>">
...
?>
 ...
 <input name="SeatPriceInn" id="SeatPriceInn" class="seatData" type="hidden" value="0" >

 <input name="SeatPriceInn2" id="SeatPriceInn2" class="seatData" type="hidden" value="0" > 

 <input name="SeatNoInn" id="SeatNoInn" class="seatData" type="hidden" value="" >

 <input name="SeatNoInn2" id="SeatNoInn2" class="seatData" type="hidden" value="" >  
