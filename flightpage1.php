...
.holidestibox .card:hover,
.packagedestination:hover{
...
.offersection .card:hover img,
.packagedestination:hover img{
...
<body>
   ...
   <div class="textcontent">
      ...
      <div class="container">
         ...
         if (!empty($Marqueedata) && $Marqueedata['id'] != '') {
      ...
      <?php echo (!empty($cms['bodyScript']))?$cms['bodyScript']:''; ?>
   ...
   <?php echo (!empty($cms['footerScript']))?$cms['footerScript']:''; ?>
