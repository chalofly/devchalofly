...
$dd = GetPageRecord('*', 'homeBanner', ' name="Holidays" and type=2 and status=1');
$banner = mysqli_fetch_array($dd);
...
?>
      ...
      <title><?php if($cms['metaTitle']!=""){ echo $cms['metaTitle']; }else{ echo "Holidays - www.chalofly.com"; } ?></title>
...
<meta property="twitter:creator" content="<?php echo $cms['twitterCreator']; ?>"/>
      ...
      <style>
         ...
         .holicontainer, .travelcontainer, .lastcon { padding: 0px 60px; }
            .holidaysearch .redbuttonsearch{ margin-bottom:20px !important;}
     ...
     .holidaysearch h1{font-size: 14px !important;text-shadow: 2px 2px 5px rgba(0, 0, 0, 0.5);}

     .holidaysearch .textfield{padding: 10px 17px !important;}

     .holidaysearch .redbuttonsearch{padding: 9px 20px !important; }

     .holidaybanner{height: 210px !important;}

     .phoneholibox .card{border-radius: 13px !important;}

     .holidestibox{margin-top: 10px !important;}

     .mbleftdiv{text-align: left !important; padding-left: 4px !important; margin-top: 10px !important;}

     .holipricing{justify-content: left !important;}

     .phoneholibox .card{border: 1px solid #00a1e573 !important;}

     .testibg{padding-top: 10px !important;}

     .lastcon .row{display: grid; grid-template-columns: 50% 50%; padding-right: 15px !important;}

     .mobedit1{height: 160px !important; margin: 0px !important;}

     .mobedit1 img{height: auto !important; min-height: 100% !important; object-fit: cover !important}

     .lastcon .col-lg-2{padding-right: 0px !important;}

     .lastcon tr td{padding: 7px !important}
   ...
   <body class="greybluebg">
      ...
      <section class="holidaybanner" style="background-image: url(<?php echo $fullurl; ?>admin/package_image/<?php echo $banner['photo']; ?>);">
               ...
               <div class="col-lg-12">
                  ...
                  <div class="holidaysearch">
                     ...
                     <h1 style="color:#fff;">
                        ...
                        <i class="fa fa-suitcase" aria-hidden="true"></i> Holiday Tour Packages
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td>
                                    ...
                                    <select class="textfield"  name="holidaysdestination" style=" margin-bottom:20px !important;">
                                       ...
                                       <option value="<?php echo $destinationMaster['name']; ?>" <?php if($_REQUEST['holidaysdestination']==$destinationMaster['id']){?>selected="selected"<?php } ?>><?php echo $destinationMaster['name']; ?></option>
                                 ...
                                 <td width="23%">
								    ...
								    <input type="submit" name="Submit" value="SEARCH" class="redbuttonsearch cbtn-clr">
         ...
         <div class="container holicontainer">
            ...
            <div class="row">
               ...
               <?php 
                  ...
                  $bbb = GetPageRecord('*', 'sys_packageBuilder', '  showwebsite=1  and queryId=0 and grossPrice>0  order by id desc '); 

                  while ($packagelist = mysqli_fetch_array($bbb)) {  
                  ...
                  <div class="holidestibox phoneholibox">
                     ...
                     <div class="card">
                        ...
                        <div class="holiimg">
                           ...
                           <a target="_blank" href="<?php echo $fullurl; ?>package/<?php echo stripslashes($packagelist['seoURL']); ?>"><img src="<?php echo $packagephotourl; ?><?php echo $packagelist['coverPhoto']; ?>" class="img-fluid" alt="<?php echo stripslashes($packagelist['name']); ?>"></a>

                        </div>

                        <div class="card-body">

                           <h3 class="card-title"><a target="_blank" href="<?php echo $fullurl; ?>package/<?php echo stripslashes($packagelist['seoURL']); ?>" style="color:#000000;"><?php echo stripslashes($packagelist['name']); ?></a></h3>

                           <div class="mbleftdiv" style="text-align:center;"><i class="fa fa-calendar" aria-hidden="true"></i> <?php echo ($packagelist['days']-1); ?> Nights  / <?php echo ($packagelist['days']); ?> Days</div>

                           <div class="holipricing">

                              <p><a href=""><?php echo convertfromtocurrencywithcurr('INR',$_SESSION['currency'],round($packagelist['grossPrice'])); ?></a></p>
    ...
    <?php
		...
		include_once('weight/section_testimonials.php');
         ...
         <div class="offerrow">
            ...
            <div class="row" style="padding-left: 3px;padding-right: 3px;">
               ...
               <?php
                  ...
                  $dm = GetPageRecord('*', 'websiteDestination', 'name in (SELECT destinations FROM sys_packageBuilder WHERE showwebsite=1 and showinPopular=1) order by id desc');
