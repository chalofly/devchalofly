               ...
               <div class="card" >
                  <div class="card-body">
                     <h4 class="card-title" style=" margin-top:0px; overflow:hidden;">
                        <?php if($_REQUEST['id']!=''){ echo 'Edit'; } else { echo 'Add'; } ?> Landing Page
                                       ...
                                       <div class="row"  style="padding: 5px; margin: 5px; border: 1px solid #ddd; padding-top: 12px; border-radius: 4px;">
                                          ...
                                          <div class="col-lg-4">
                                             <div class="form-group"> 
                                                ...
                                                <input type="text" class="form-control" id="seoTag1" name="seoTag1" value="<?php echo stripslashes($editresult['seoTag1']); ?>" >
                                             </div>
                                          </div>
                                          <div class="col-lg-4">
                                             <div class="form-group"> 
                                                <label for="validationCustom02">Seo Tag 2</label>
                                                <input type="text" class="form-control" id="seoTag2" name="seoTag2" value="<?php echo stripslashes($editresult['seoTag2']); ?>" >
                                             </div>
                                          </div>
                                          <div class="col-lg-4">
                                             <div class="form-group"> 
                                                <label for="validationCustom02">Seo Tag 3</label>
                                                <input type="text" class="form-control" id="seoTag3" name="seoTag3" value="<?php echo stripslashes($editresult['seoTag3']); ?>" >
                                             </div>
                                          </div>
                                          <div class="col-lg-6">
                                             <div class="form-group"> 
