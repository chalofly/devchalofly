<?php 
   ...
   if($_REQUEST['dltid']!=''){
      deleteRecord('websiteDestination','id="'.decode($_REQUEST['dltid']).'"');  
   ?>
<script>
   alert('Successfully Deleted!');
   window.location.href = 'display.html?ga=website-destinations';
</script>
<?php
   } 
?>
            ...
            <div class="newboxheading">
               <div class="newhead">
                  ...
                  <div class="newoptionmenu">
                     <div> <button type="button" class="btn btn-secondary btn-lg waves-effect waves-light"  onclick="loadpop2('Add Destination',this,'600px')" data-toggle="modal" data-target="#myModal2" data-backdrop="static" popaction="action=addwebsitedestination">Add Destination</button></div>
                     <div>
                              ...
                              <tr>
                                 <td>
                                    <table border="0" cellpadding="0" cellspacing="0"  class="addbynewbadges">
                                       <tr>
                                          <?php if($rest['photo']!=''){ ?> 
                                          <td colspan="2"  style="padding-right:10px !important;"><img src="<?php echo $fullurl; ?>package_image/<?php echo stripslashes($rest['photo']); ?>" width="25" height="25" /></td>
                                          <?php } ?>
                                          <td><?php echo stripslashes($rest['name']); ?></td>
                                       </tr>
                                    </table>
                                 </td>
                                 <td><?php echo stripslashes($rest['theme']); ?></td>
                                ...
                                <td width="5%">
                                 <div style="display:flex; align-items:center; gap:8px;">
                                    ...
                                    <a class="dropdown-item neweditpan"
                                       onclick="loadpop2('Edit Destination',this,'600px')"
                                       data-toggle="modal"
                                       data-target="#myModal2"
                                       data-backdrop="static"
                                       popaction="action=addwebsitedestination&id=<?php echo encode($rest['id']); ?>">
...
<script>
   function dltfunction(id)
   {
      ...
      {
        window.location.href = 'display.html?ga=website-destinations&dltid='+id;
      }
   }  
 </script>  