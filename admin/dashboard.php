...
<?php
    ...
    if ($time < "12") {
		...
		$timeimg='dash-afternoonicon.png';
    } else
    ...
    if ($time >= "17" && $time < "19") {
		...
		$timeimg='dash-eveningicon.png';
    } else
    /* Finally, show good night if the time is greater than or equal to 1900 hours */
    if ($time >= "19") {
        $daytime="Good Night";
		$timeimg='dash-nighticon.png';
    }
	?>

       <div class="card" style="overflow: hidden; background-image: url(images/grnbx.png); background-repeat: no-repeat; background-position: right top; background-size: auto 100%; position:relative;">
	   <div class="card-body" style="padding: 16px;">
	   <h2 class="morningh2"><?php echo $daytime; ?></h2>
	<div style="font-size:14px; font-weight:600;"><?php echo stripslashes($LoginUserDetails['firstName']).' '.stripslashes($LoginUserDetails['lastName']); ?></div>
	
	<div style="position: absolute; right: 10px; top: 20px; text-align: center; line-height: 18px; font-size: 12px; color: #fff; font-weight: 700; text-transform: uppercase; width: 32%;"><span style="font-size:22px; font-weight:600;"><?php echo date('d'); ?></span><div style="text-align:center;"><?php echo date('D, F Y'); ?></div></div>
	   </div>
	   </div>
...
<div class="col-xl-12">
  ...
  <tr>
    <td colspan="2" align="center" bgcolor="#fef1e1"><img src="images/icons8-circled-user-male-skin-type-7-64.png" width="20"  /> </td>
  ...
  <tr>
    <td colspan="2" align="center" bgcolor="#e0f5f1"><img src="images/icons8-new-copy-80.png" width="20"  /> </td>
  ...
  <tr>
    <td colspan="2" align="center" bgcolor="#f5e0ee"><img src="images/icons8-open-envelope-80.png" width="20"  /> </td>
  ...
  <tr>
    <td colspan="2" align="center" bgcolor="#ede5fd"><img src="images/icons8-open-box-64.png" width="20"  /> </td>
...
<div class="col-xl-6">
       ...
       <div class="card">
	    <a href="display.html?startDate=<?php echo date('d-m-Y'); ?>&endDate=<?php echo date('d-m-Y'); ?>&keyword=&page=&ga=query&searchcity=&searchusers=&searchsource=" style="color:#000;"> 
	  <div class="card-body">
	  	  <div class="cardsmheading">Today's Queries</div> 
	  <div class="cardnumberbig"><?php echo countlisting('id','queryMaster',' where   DATE(dateAdded)="'.date('Y-m-d').'" '.$mainwhere.'  ');   ?> <i class="fa fa-external-link" aria-hidden="true" style="background-color:#5eaafd33; color:#3892ca;"></i></div>
...
<div class="col-xl-6">
       <div class="card">
	    <a href="display.html?startDate=01-01-<?php echo date('Y',strtotime(' - 1 Year')); ?>&endDate=<?php echo date('d-m-Y'); ?>&keyword=&page=&ga=query&searchcity=&searchusers=&searchsource=" style="color:#000;"> 
	  <div class="card-body">
	  	  <div class="cardsmheading">Total Queries</div> 
	  <div class="cardnumberbig"><?php echo countlisting('id','queryMaster',' where  1 '.$mainwhere.'   ');   ?> <i class="fa fa-external-link" aria-hidden="true" style="background-color:#a0a0a033; color:#6e6e6e;"></i></div>
...
<div class="col-xl-6">
       <div class="card">
	    <a href="display.html?startDate=01-01-<?php echo date('Y',strtotime(' - 1 Year')); ?>&endDate=<?php echo date('d-m-Y'); ?>&keyword=&page=&ga=query&searchcity=&searchusers=&searchsource=&statusid=8" style="color:#000;"> 
	  <div class="card-body">
	  	  <div class="cardsmheading">Proposal Sent</div> 
	  <div class="cardnumberbig"><?php echo countlisting('id','queryMaster',' where   statusId=8 and clientId in (select id from userMaster where userType=4 and firstName!="") '.$mainwherecnfq.' ');   ?> <i class="fa fa-external-link" aria-hidden="true" style="background-color:#cc00a917; color:#cc00a9;"></i></div>
...
<div class="col-xl-6">
       <div class="card">
	    <a href="display.html?startDate=01-01-<?php echo date('Y',strtotime(' - 1 Year')); ?>&endDate=<?php echo date('d-m-Y'); ?>&keyword=&page=&ga=query&searchcity=&searchusers=&searchsource=&statusid=9" style="color:#000;"> 
	  <div class="card-body">
	  	  <div class="cardsmheading">Total Pro. Conf</div> 
	  <div class="cardnumberbig"><?php echo countlisting('id','queryMaster',' where   statusId=9  and clientId in (select id from userMaster where userType=4 and firstName!="") '.$mainwherecnfq.' ');   ?> <i class="fa fa-external-link" aria-hidden="true" style="background-color:#389aca33; color:#389aca;"></i></div>
...
<div class="col-xl-6">
       <div class="card">
	  <a href="display.html?startDate=01-01-<?php echo date('Y',strtotime(' - 1 Year')); ?>&endDate=<?php echo date('d-m-Y'); ?>&keyword=&page=&ga=query&searchcity=&searchusers=&searchsource=&statusid=5" style="color:#000;"> 
	  <div class="card-body">
	  	  <div class="cardsmheading">Total Confirmed</div> 
	  <div class="cardnumberbig"><?php echo countlisting('id','queryMaster',' where   statusId=5  and clientId in (select id from userMaster where userType=4 and firstName!="") '.$mainwherecnfq.' ');   ?> <i class="fa fa-external-link" aria-hidden="true"></i></div>
...
<div class="col-xl-6">
       <div class="card">
	 <a href="display.html?startDate=01-01-<?php echo date('Y',strtotime(' - 1 Year')); ?>&endDate=<?php echo date('d-m-Y'); ?>&keyword=&page=&ga=query&searchcity=&searchusers=&searchsource=&statusid=7" style="color:#000;"> 
	  <div class="card-body">
	  	  <div class="cardsmheading">Total Lost</div> 
	  <div class="cardnumberbig"><?php echo countlisting('id','queryMaster',' where   statusId=7  '.$mainwhere.' and clientId in (select id from userMaster where userType=4 and firstName!="")  ');   ?> <i class="fa fa-external-link" aria-hidden="true" style="background-color:#f9392f21; color:#f9392f;"></i></div>
...
<div class="card">
                                <div class="card-body"  >
									...
									<div style="height:281px; overflow:auto;"><div class="taskfollowuplist">
<?php
 $totalno=1;

$a=GetPageRecord('*','queryTask',' 1 '.$mainwhere.' and (makeDone!=1 ) and taskType!="Notification" order by id desc limit 0,50');
...
<div class="card" id="showtodayspayment">
                                        <div class="card-body" >
									   <p class="text-muted font-weight-medium mt-1 mb-2 dashheader">Payment Collection </p>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="60%" align="center"><table width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr>
...
while($stageres=mysqli_fetch_array($a)){
	...
	$leadstagecount=mysqli_fetch_assoc($abcd);
	
	?>
{
	"name": "<?php echo ($stageres['name'])." ". $leadstagecount['totalsages'];?>",
...
// series.labelsContainer.paddingLeft = 50;
...
// }); // end am4core.ready()
						 ...
						 <p class="text-muted font-weight-medium mt-1 mb-2 dashheader">Today Tours (<?php echo $resttotal['totaltours']; ?>)</p>
...
$wherequeryt=' and assignTo="'.$_SESSION['userid'].'" ';
}
...
<?php if($LoginUserDetails['userType']==0){  ?>
     <div class="row">
	  ...
	  <div class="col-xl-12"> <div class="card">
			...
			<?php
			$c=1;   
			$rs=GetPageRecord('count(destinationId) as totalquery,destinationId','queryMaster',' 1 and destinationId>0 group by destinationId order by totalquery desc LIMIT 0,5 '); 
			while($rest=mysqli_fetch_array($rs)){  
			?>  
			<div class="col-xl-2">
			<a href="display.html?startDate=&endDate=&keyword=&page=&ga=query&searchcity=<?php echo $rest['destinationId']; ?>&searchusers=&searchsource=" style="color:#000000;"> <div  class="card" style="margin:0px; background-color:<?php if($c==1){ ?>#FFE1E1;<?php } ?><?php if($c==2){ ?>#fae4e4;<?php } ?><?php if($c==3){ ?>#f7e7e7;<?php } ?><?php if($c==4){ ?>#f7ebeb;<?php } ?><?php if($c==1){ ?>#FFE1E1;<?php } ?>"> 
			<div class="card-body" style="text-align:center; font-size:16px; padding:7px; font-weight:600;" >
			<?php echo  getCityName($rest['destinationId']); ?> (<?php echo $rest['totalquery']; ?>)
			</div>
			</div>	</a>
			</div> 
...
$totalnetCost=$netCost+$totalnetCost;
 ...
 echo '&#8377;'.number_format(round($totalnetCostfinal-$totalnetCostfinalpaid)); ?>
