...
<option value="Flight" <?php if($editresult['pageType']=='Flight'){ ?>selected="selected"<?php } ?>>Flight</option>
<option value="Bus" <?php if($editresult['pageType']=='Bus'){ ?>selected="selected"<?php } ?>>Bus</option>
<option value="Other" <?php if($editresult['pageType']=='Other'){ ?>selected="selected"<?php } ?>>Other</option> 
										...
										<div class="col-lg-3">
                                          ...
                                          <input type="text" class="form-control redborder" id="url" name="url"  value="<?php echo stripslashes($editresult['url']); ?>" <?php if($editresult['url']!=""){ ?> readonly <?php } ?>>
                                        </div>
										</div> 
...
CKFinder.setupCKEditor( editor,'ckeditor/ckfinder/' ) ;
										...
										<div class="col-lg-3">
                                             <div class="form-group"> 
                                                <label for="validationCustom02">Tab Title</label>
                                                <input type="text" class="form-control redborder" id="tabTitle" name="tabTitle"    value="<?php echo stripslashes($editresult['tabTitle']); ?>">
                                             </div>
                                          </div>
										 ...
										 <div class="col-lg-3">
                                             <div class="form-group"> 
                                                ...
                                                <input type="text" class="form-control redborder" id="robotTag" name="robotTag"    value="<?php echo stripslashes($editresult['robotTag']); ?>">
                                             </div>
                                          </div>
										...
										<div class="col-lg-3">
										  ...
										  <div class="col-lg-4">
                                             <div class="form-group"> 
                                                ...
                                                <textarea name="bodyScript" rows="3" class="form-control redborder" id="bodyScript"><?php echo stripslashes($editresult['bodyScript']); ?></textarea>
                                             </div>
                                          </div>
