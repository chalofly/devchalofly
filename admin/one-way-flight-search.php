...
?>
<?php  if($LoginUserDetails['userType']=='agent' && $LoginUserDetails['userType']=='agent'){ ?>
...
<?php if($LoginUserDetails['userType']=='agent' && $getapistatus['fixedAK']==1) { ?>
...
<?php  if($LoginUserDetails['userType']=='agent' && $getapistatus['fixedGF']==1){ ?>
<iframe style="display:none;"  id="secframeload" name="secframeload" src="<?php echo "fixed-FS-Search-API.php".$geturl; $undercons=1;  ?>"></iframe>  
<?php } ?>
