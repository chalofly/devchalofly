...
$ab=GetPageRecord('commissionType','sys_userMaster','  id="'.$_SESSION['agentUserid'].'" ');   
$admincommisiontype=mysqli_fetch_array($ab);  
...
/*========================================================Admin==============================================================================================*/ 
 ...
 ?>
 <script>
// alert('<?php echo ' sectorType="'.$_SESSION['domesticorinter'].'"  and name in (select displayType from fareTypeMaster where FIND_IN_SET("'.trim($fareType).'",fareTypeName) ) and agentTypeGroupId="'.$admincommisiontype['commissionType'].'" and flightId in (select id from domesticFlightsMarkupMaster where name="'.$flightName.'")'; ?>');
 </script>
 <?php

}

$a=GetPageRecord('*','agent_fareTypedomesticFlightsMarkupMaster',' sectorType="'.$_SESSION['domesticorinter'].'"  and name in (select displayType from fareTypeMaster where FIND_IN_SET("'.trim($fareType).'",fareTypeName) ) and agentTypeGroupId="'.$admincommisiontype['commissionType'].'" and flightId in (select id from domesticFlightsMarkupMaster where name="'.$flightName.'")');   
...
// alert('<?php echo $pax; ?>,<?php echo $fareType; ?>,<?php echo $taxCost; ?>,<?php echo $taxCost; ?>');
...
// alert('<?php echo $pax; ?>,<?php echo $fareType; ?>,<?php echo $taxCost; ?>,<?php echo $finalCost; ?>,<?php echo ' sectorType="'.$_SESSION['domesticorinter'].'"  and name in (select displayType from fareTypeMaster where FIND_IN_SET("'.trim($fareType).'",fareTypeName) ) and agentTypeGroupId="'.$admincommisiontype['commissionType'].'" and flightId in (select id from domesticFlightsMarkupMaster where name="'.$flightName.'")'; ?>');
...
$rs7=GetPageRecord('*','sys_userMaster',' id="'.$_SESSION['agentUserid'].'"');  
...
$a=GetPageRecord('*','fareTypedomesticHotelMarkupMaster','  1 and   addBy=1 and hotelId in (select id from domesticHotelMarkupMaster where name="'.$hotelName.'" and groupId="'.$hotelhave['commissionType'].'") order by id desc');   
...
$a=GetPageRecord('*','fareTypedomesticHotelMarkupMaster',' 1 and  addBy=1 and hotelId in (select id from domesticHotelMarkupMaster where name="All" and groupId="'.$hotelhave['commissionType'].'") order by id desc');   
