...
if(isset($_SESSION['order_id']) && isset($_SESSION['amount']) &&  isset($_SESSION['phone']) && isset($_SESSION['user_email'])){
...
<input id="firstname" class="firstname" name="firstname" value="<?php echo $_SESSION["user_email"]; ?>" type="hidden">
