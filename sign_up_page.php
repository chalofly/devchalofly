...
<body id="loginbg" class="loginbody">
  ...
  <!-- header -->
    ...
    <div id="loginouter" style="height: auto;margin-top: 20px ;margin-bottom: 20px ; position:inherit;   ">
...
<?php } ?>
            ...
            <option value="">Select Your City</option>
					...
					<div class="col-12">
                            <div class="mb-3">
                                <label for="referralCode" class="form-label">Referral Code</label><br>
                                <input name="referralCode" type="text" class="form-control" id="referralCode" value="" size="30">
                            </div>
                   </div>
