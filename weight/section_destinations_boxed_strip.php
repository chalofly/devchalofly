<style>
   ...
   .offerheading p {font-size: 30px; margin: 0; padding-bottom: 0; font-weight: 800;}

   .offerbardealsfeaturedes {box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px; border-radius: 5px; padding: 20px 20px 0; margin-top: 30px;}

   .offerheadingflight1{padding: 20px 20px 30px;}
                     ...
                     <div class="tab-wrapper">
                        ...
                        <ul class="tabs">
                           ...
                           <?php
                              ...
                              $popDest=GetPageRecord('destinationId','popularDestinations','status="1" and type="1" group by destinationId order by id desc ');
                           ...
                           <li class="tab-link <?php echo $active; ?>" data-tab="Popular_<?php echo $popDestData["destinationId"]; ?>"><?php echo $rsData["name"]; ?></li>
...
$popDest1=GetPageRecord('*','popularDestinations','status="1" and type="1" group by destinationId order by id desc ');

while($popDestData1=mysqli_fetch_array($popDest1)){

?>

                  <div id="tab-Popular_<?php echo $popDestData1["destinationId"]; ?>" class="tab-content <?php echo $active; ?>">
...
$popDest2=GetPageRecord('*','popularDestinations','status="1" and type="1" and destinationId="'.$popDestData1["destinationId"].'"');
