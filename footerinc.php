...
var totalAmountToPay = $('#totalAmountToPay').val();
	$('#payResponseId').load('actionpage.php?action=paymentGatewayPayment&serviceId=<?php echo $_SESSION['serviceId']; ?>&type=<?php echo $bookingServiceType; ?>&totalAmountToPay='+totalAmountToPay);
}
...
<?php echo $websitesetting['footerScript']; ?>