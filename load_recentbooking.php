...
<div class="tbtabsouter">
   ...
   <a  onClick="recentbooking('flight_group_request');"  <?php if($id=='flight_group_request'){ ?>class="active"<?php } ?>>Flight Group  Request</a> 
</div>
<?php if($id=='flight'){ 
            ...
            <td align="left" valign="middle">
               ...
               <strong>
                  <div style="color:#CC0000; margin-top:2px;"><i
                     ...
                     <?php echo date('d-m-Y', strtotime($rest['journeyDate'])); ?>
                  </div>
                  <?php if($rest['pnrNo']!=''){?>
                  <div class="pnrtag"><i class="fa fa-tag" aria-hidden="true"></i> <?php echo stripslashes($rest['pnrNo']); ?></div>
                  <?php } ?>	
               </strong>
            </td>
            <td align="left" valign="middle"><strong>From:
               </strong><?php echo $rest['source']; ?><br><strong>To:</strong> <?php echo $rest['destination']; ?>
            </td>
   ...
   <table border="1" cellpadding="5" cellspacing="0" bordercolor="#CCCCCC" class="table" style="margin-bottom:0px;">
      ...
      <tbody>
         ...
         <tr onClick="loadpop('View Hotel Voucher',this,'900px')" data-toggle="modal" data-target=".bs-example-modal-center" popaction="action=viewHotelVoucher&id=<?php echo  encode($rest['id']); ?>&page=<?php echo $_REQUEST['ga']; ?>">
            ...
            <td align="left" valign="middle">
               <span style="color:#000;"><?php for($i=1; $i<=$rest['Rating']; $i++){ ?><i class="fa fa-star" aria-hidden="true" style="font-size:12px; color: #ffbc00;"></i><?php } ?><br>
               <strong><?php echo stripslashes($rest['HotelName']); ?></strong><br>
               City: 
               <strong>
                  <?php echo stripslashes($rest['Destination']); ?>
                  <div style="color:#CC0000; margin-top:2px;"><i class="fa fa-calendar-check-o" aria-hidden="true"></i>
                     <?php echo date('d-m-Y', strtotime($rest['CheckIn'])); ?>
                  </div>
                  <?php if($rest['pnrNo']!=''){?>
                  <div class="pnrtag"><i class="fa fa-tag" aria-hidden="true"></i> <?php echo stripslashes($rest['pnrNo']); ?></div>
                  <?php } ?>	
...
<div class="tbtabcontent">
   ...
   <table border="1" cellpadding="5" cellspacing="0" bordercolor="#CCCCCC" class="table" style="margin-bottom:0px;">
      ...
      <tbody>
         ...
         <tr  >
            <td align="left" valign="middle">
               <span style="color:#000;"><?php echo strip($rest['hotelName']); ?> <br />
      ...
      <tbody>
         ...
         <tr>
            <td align="left" valign="top">
               <strong><?php echo strip($rest['packageName']); ?></strong>
               <div style="width:140px;"><?php echo date('d-m-Y h:i A', strtotime($rest['addDate'])); ?></div>
            </td>
...
<?php if($id=='flight_group_request'){ 
   $flightGroupRequests=GetPageRecord('*','group_requests','addedBy="'.$_SESSION["agentUserid"].'" order by id desc');  
   ?>
<div class="tbtabcontent">
   <?php if(mysqli_num_rows($flightGroupRequests)>0){ ?>
   <table border="1" cellpadding="5" cellspacing="0" bordercolor="#CCCCCC" class="table" style="margin-bottom:0px;">
      <thead>
         <tr style="background-color: #f6f6f6;">
            <th>Trip Type </th>
      ...
      <tbody>
	<?php 
	while($rest=mysqli_fetch_array($flightGroupRequests)){ 
	?>
         <tr>
           <td><?php echo $rest["tripType"]; ?></td>
           <td><?php echo $rest["fromcitydesti"]; ?></td>
           <td><?php echo $rest["tocitydesti"]; ?></td>
           <td><?php echo $rest["fromDate"]; ?></td>
           <td><?php if($rest["returnDate"]!="" && $rest["returnDate"]!="1970-01-01"){ echo $rest["returnDate"]; } ?></td>
           <td><?php echo $rest["preferredAirline"]; ?></td>
           <td><?php echo $rest["pax"]; ?></td>
           <td><?php echo $rest["class"]; ?></td>
           <td><?php echo $rest["leadPaxName"]; ?></td>
           <td><?php echo $rest["leadPaxNumber"]; ?></td>
           <td><?php echo $rest["remark"]; ?></td>
		  <!-- <td><a class="neweditpan pl-1" onclick="deleteEnq('<?php echo encode($rest['id']); ?>');"><i class="fa fa-trash" aria-hidden="true" style="color:#FF8080;"></i></a></td>-->
         </tr>
         <?php } ?>
      </tbody>
   </table>
   ...
   <div style="text-align:center; padding:30px;">
      <img src="data:image/png;base64,">
      <div style="margin-top:10px; ">Data Not Found</div>
   </div>
   <?php } ?>
</div>
<?php } ?>
...
if (result==true) {
$('#ActionDiv').load('actionpage.php?did='+id+'&action=deleteEnq');
} else {
return false;
}
}
