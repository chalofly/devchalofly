<?php 
   ...
   $a=GetPageRecord('*','sys_packageBuilder',' seoURL="'.($_REQUEST['i']).'" and showwebsite="1"'); 
   ...
   $cc = GetPageRecord('*', 'cmsPages', ' pageType="Services" and url="holidays" and status=1');
...
<html lang="en">
   <head>
      ...
      <title><?php if($rest['metaTitle']!=""){ echo $rest['metaTitle']; } else if($cms['metaTitle']!=""){ echo $cms['metaTitle']; }else{ echo "Holidays - www.chalofly.com"; } ?></title>
      <meta name="keywords" content="<?php echo stripslashes($rest['metaKeyword']); ?>">
      <meta name="description" content="<?php echo stripslashes($rest['metaDescription']); ?>">
      <meta name="keywords" content="<?php echo stripslashes($rest['seoTag1']); ?>">
      <meta name="keywords" content="<?php echo stripslashes($rest['seoTag2']); ?>">
      <meta name="keywords" content="<?php echo stripslashes($rest['seoTag3']); ?>">
      <meta name="robots" content="<?php echo $rest['robotTag']; ?>">
      <meta property="og:site_name" content="<?php echo $rest['ogsiteName']; ?>"/>
      <meta property="og:type" content="<?php echo $rest['ogType']; ?>"/>
      <meta property="og:title" content="<?php echo $rest['ogmetaTitle']; ?>"/>
      <meta property="og:description" content="<?php echo $rest['ogmetaDescription']; ?>"/>
      <meta property="og:image" content="<?php echo $rest['ogImage']; ?>"/>
      <meta property="og:url" content="<?php echo $rest['ogURL']; ?>"/>
      <meta name="twitter:title" content="<?php echo $rest['twitterMetaTitle']; ?>"/>
      <meta name="twitter:description" content="<?php echo $rest['twitterMetaDescription']; ?>"/>
      <meta property="twitter:image" content="<?php echo $rest['twitterImage']; ?>"/>
      <meta property="twitter:site" content="<?php echo $rest['twitterSite']; ?>"/>
      <meta property="twitter:creator" content="<?php echo $rest['twitterCreator']; ?>"/>
      <?php include "headerinc.php"; ?> 
      <link href="https://fonts.googleapis.com/css2?family=Clash+Display:wght@500;600;700&family=Manrope:wght@300;400;500;600;700&display=swap" rel="stylesheet">
      <!-- <link rel="stylesheet" href="css/lightbox.min.css"> -->
       <link rel="stylesheet" href="<?php echo $fullurl; ?>css/lightbox-new.css">
      <!-- <style>
         .card { border-radius: 10px; margin-bottom:20px; margin-top:20px; }
         .actiimgbox{width:100%; border-radius: 10px; overflow:hidden; height:170px;}
         .actiimgbox img{width:100%; min-height:150px; border-radius: 10px;object-fit: cover; height: 100%;}
         .dayboxes .row{ margin-bottom:20px;}
         .dayboxes .row .card-body{ padding-top:0px !important;}
         .termscss p{margin:0px; display:inline; font-size:14px !important; color:#000000 !important;}
         .termscss br{margin:0px; display:inline; font-size:14px !important; color:#000000 !important;}
         .termscss span{margin:0px; display:inline; font-size:14px !important; color:#000000 !important;}
         .termscss div{margin:0px; display:inline; font-size:14px !important; color:#000000 !important;}
      </style> -->
      <?php echo $rest['headerScript']; ?>
   </head>
   <body class="greybluebg">
      <?php include "header.php";
         $a=GetPageRecord('*','sys_packageBuilder',' seoURL="'.($_REQUEST['i']).'"'); 
         $rest=mysqli_fetch_array($a);
         $b=GetPageRecord('*','websitePackageTheme',' id="'.$rest['packageThemeId'].'"'); 
         $restTheme=mysqli_fetch_array($b);  
		?>
            ...
            <div class="hoteldetail">
               <div class="hoteldetailone">
                  ...
                  <div class="holidatnightbox">
                     <div class="daynight">
                        <?php echo ($rest['days']-1); ?> Nights  / <?php echo ($rest['days']); ?> Days
                     </div>
               ...
               <div class="hoteldetailtwo">
                  <div class="roompricing">
                     <div style="margin-top: 20px;">
                        <div><strong id="toppriceht"><?php echo convertfromtocurrencywithcurr('INR',$_SESSION['currency'],round($rest['grossPrice'])); ?> </strong></div>
                        <p>Best Price</p>
                     </div>
                  </div>
               </div>
            </div>
            <div class="row hoteldetailrow" style="margin-top: 0px;border-radius: 22px !important; overflow: hidden;">
               <div class="col-lg-5">
                  <div class="roomoneimg borderleft">
                     <?php 
                        $n=1;
                        	$a1=GetPageRecord('*','itinerariesGallery',' itinerariesId	="'.$rest['id'].'" order by id asc limit 0,1');  
                        	while($res1=mysqli_fetch_array($a1)){ 
                        ?>
                     <img class="example-image-link" data-lightbox="example-set" data-title="<?php if($rest['agentId']==0){ echo $imgurl.$res1['img'];  } else { echo 'upload/'.$res1['img']; } ?>" alt="<?php if($n==1){ echo stripslashes($rest['imgAltTag']); } ?>" src="<?php if($rest['agentId']==0){ echo $packagephotourl.$res1['image'];  } else { echo $packagephotourl.$res1['image']; } ?>" >  
                     <?php $n++; } ?>
                  </div>
               </div>
               <div class="col-lg-5">
                  <div class="roomoneimg">
                     <?php 
                        $n=2;
                        $a12=GetPageRecord('*','itinerariesGallery','  itinerariesId	="'.$rest['id'].'"   order by id asc limit 1,1');  
                        while($res1=mysqli_fetch_array($a12)){ 
                        
                        ?>
                     <img class="example-image-link" data-lightbox="example-set" data-title="<?php if($rest['agentId']==0){ echo $imgurl.$res1['img'];  } else { echo 'upload/'.$res1['img']; } ?>" alt="<?php if($n==2){ echo stripslashes($rest['imgAltTag2']); }  ?>" src="<?php if($rest['agentId']==0){ echo $packagephotourl.$res1['image'];  } else { echo $packagephotourl.$res1['image']; } ?>" >  
                     <?php $n++; } ?>
                     <div class="camerabox">
               ...
               <div class="col-lg-2" style="padding-right: 0px;">
                  <div class="roomtwoimg">
                     <?php 
                        $n=3;
                        $a11=GetPageRecord('*','itinerariesGallery','  itinerariesId	="'.$rest['id'].'" order by id asc limit 2,2');  
                        while($res1=mysqli_fetch_array($a11)){ 
                        ?>
                     <img class="example-image-link" data-lightbox="example-set" data-title="<?php if($rest['agentId']==0){ echo $imgurl.$res1['img'];  } else { echo 'upload/'.$res1['img']; } ?>" alt="<?php if($n==3){ echo stripslashes($rest['imgAltTag3']); } if($n==4){ echo stripslashes($rest['imgAltTag4']); } ?>" src="<?php if($rest['agentId']==0){ echo $packagephotourl.$res1['image'];  } else { echo $packagephotourl.$res1['image']; } ?>" >  
                     <?php $n++; } ?>
                  </div>
               </div>
            </div>
               ...
               <div class="col-lg-8" style="padding-left: 0px; border-left: 0px;">
                  <div class="card" style="border: 0px;box-shadow: 0px 10px 18px #29426917;">
                     <div class="description holidaydetaildes">
                        <h2>Package <span>Overview</span></h2>
                        <p><?php echo nl2br(stripslashes($rest['aboutPackage'])); ?></p>
                     ...
                     <div class="row">
                        <div class="col-lg-12">
							<div class="dayheading" style="padding-left:24px; font-size:15px;font-weight:700;">Day Plan</div>
                           <?php
                              $n=1;
                              $begin = new DateTime( $rest['startDate'] );
                              $end   = new DateTime( $rest['endDate'] );

                              for($i = $begin; $i <= $end; $i->modify('+1 day')){

                              $abcde=GetPageRecord('*','sys_packageBuilderEvent',' packageDays="'.$n.'" and packageId="'.$rest['id'].'"'); 
                           ...
                           <div class="dayboxes">
                              <div class="datebg">
                                 ...
                                 <p><?php echo stripslashes($dayDetailsData['daySubject']); ?></p>
                              </div>
                              <div style="margin-bottom:20px; background-color:#FFFFF0; padding:20px; border:1px solid #ddd; margin-top:10px; font-size:14px; color:#000000;border-radius: 10px;">
                                 <div class="daytext">
                                    <?php echo nl2br(stripslashes($dayDetailsData['dayDetails'])); ?> 
                                 </div>
                              </div>
                              <?php  
                                 $rs=GetPageRecord('*','sys_packageBuilderEvent',' packageId="'.$rest['id'].'" and packageDays="'.$n.'" and name!="" order by sr, time(checkIn) asc');
                              ...
                              <div class="row">
                                 ...
                                 <div class="<?php if($eventData['sectionType']=='Flight'){ ?>col-md-4 col-xl-4<?php } else { ?>col-md-4 col-xl-4<?php } ?>" p-0>
                                    <div class="<?php if($eventData['sectionType']=='Flight'){ ?>actiimgboxflight<?php } else {  ?>actiimgbox<?php } ?>"><img id="eventimage<?php echo $eventData['id']; ?>" <?php if($eventData['sectionType']=='Flight'){ ?> style="height:180px; width:100%;" <?php } ?>  src="<?php echo $packagephotourl; ?><?php if($eventData['eventPhoto']!=''){ echo $eventData['eventPhoto']; } else {  if($eventData['sectionType']=='Accommodation' ){ echo 'nohotel.png'; }  if($eventData['sectionType']=='Cruise' ){ echo 'nohotel.png'; }if($eventData['sectionType']=='FeesInsurance' ){ echo 'nofee.png'; }if($eventData['sectionType']=='Flight' ){ echo 'noother.png'; } } ?>" /></div>
                                 </div>
                                 <?php } ?>
                                 <?php if($eventData['sectionType']=='Transportation' || $eventData['sectionType']=='Activity'){ ?>
                                 <div class="col-md-4 col-xl-4 showinmobile ">
                                    <div class="actiimgbox"><img class="img-fluid" id="eventimage<?php echo $eventData['id']; ?>" src="<?php echo $packagephotourl; ?><?php  if($eventData['eventPhoto']!=''){ echo $eventData['eventPhoto']; } else {   if($eventData['sectionType']=='Transportation' ){ echo 'notransfer.png'; }if($eventData['sectionType']=='Activity' ){ echo 'noactivity.png'; }if($eventData['sectionType']=='Meal' ){ echo 'nomeal.png'; } } ?>" /></div>
                                 </div>
                                 <?php } ?>
                                 <div class="<?php if($eventData['sectionType']=='Flight'){ ?>col-md-8 col-xl-8<?php } else { ?>col-md-8 col-xl-8<?php } ?> itinerariesbox">
                                    <div class="card-body" style="padding-top:20px;">
                                       <h5 style="line-height: 32px; margin-top:0px; margin-bottom: 2px;"><i style="" class="fa <?php if($eventData['sectionType']=='Accommodation'){ ?>fa-bed<?php } ?><?php if($eventData['sectionType']=='Cruise'){ ?>fa-ship<?php } ?><?php if($eventData['sectionType']=='Activity'){ ?>fa-blind<?php } ?><?php if($eventData['sectionType']=='Transportation'){ ?>fa-car<?php } ?><?php if($eventData['sectionType']=='FeesInsurance'){ ?>fa-credit-card<?php } ?><?php if($eventData['sectionType']=='Meal'){ ?>fa-cutlery<?php } ?><?php if($eventData['sectionType']=='Flight'){ ?>fa-plane<?php } ?><?php if($eventData['sectionType']=='Leisure'){ ?>fa-umbrella<?php } ?>" aria-hidden="true"></i> <?php echo stripslashes($eventData['name']); ?> <?php if($eventData['flightNo']!=''){ ?> <span style="color:#FF9900; padding-left: 0px; display: block; font-size: 15px;">(<?php echo stripslashes($eventData['flightNo']); ?>)</span><?php } ?> <span style="color:#FF9900; padding-left: 0px; display: block; font-size: 15px;"><?php echo starcategory($eventData['hotelCategory']); ?></span></h5>
                                       <?php if($eventData['sectionType']=='Accommodation'){ ?>
                                       ...
                                       <div style="margin-bottom:20px;">
                                          <i class="fa fa-calendar" aria-hidden="true"></i> &nbsp;<?php echo date('d M Y',strtotime($eventData['startDate'])); ?><?php if($eventData['showTime']==1){ ?> &nbsp;<i class="fa fa-clock-o" aria-hidden="true"></i>&nbsp; <?php echo  date('g:i A',strtotime($eventData['checkIn'])); ?> TO <?php echo  date('g:i A',strtotime($eventData['checkOut'])); ?><?php } ?>
                                       </div>
                                       <?php } ?>
                                       <?php if($eventData['sectionType']=='FeesInsurance'){ ?>
                                       <div style="margin-bottom:20px;">
                                          <i class="fa fa-calendar" aria-hidden="true"></i> &nbsp;<?php echo date('d M Y',strtotime($eventData['startDate'])); ?>
                                       </div>
                                       <?php } ?>
                                       ...
                                       <div style="margin-bottom:5px;">
                                          <table border="0" cellpadding="0" cellspacing="0">
                                             <tr>
                                                <td align="center" style="padding-right:20px; font-size:12px;">
                                                   <div style="font-size:14px; font-weight:700; color:#000; margin-bottom:3px;"><?php echo  date('g:i A',strtotime($eventData['checkIn'])); ?></div>
                                                   <?php echo  stripslashes($eventData['fromDestination']); ?>
                                                </td>
                                                <td align="center" style="width:100px;">
                                                   <?php if($eventData['flightDuration']!=''){ ?>
                                                   <div style="text-align:center; font-size:11px; color:#666666;padding-bottom: 4px;"><?php echo stripslashes($eventData['flightDuration']); ?></div>
                                                   <?php } ?>
                                                   <div style="font-size:0px; border-top:2px solid #ddd; position:relative;"><i class="fa fa-plane" aria-hidden="true" style="position: absolute; font-size: 18px; transform: rotate(45deg); top: -9px; left: 40%;"></i></div>
                                                </td>
                                                <td align="center" style="padding-left:20px;">
                                                   <div style="font-size:14px; font-weight:700; color:#000; margin-bottom:3px;"><?php echo  date('g:i A',strtotime($eventData['checkOut'])); ?></div>
                                                   <?php echo  stripslashes($eventData['toDestination']); ?>
                                                </td>
                                             </tr>
                                          </table>
                                       </div>
                                       ...
                                       <?php } ?>
                                       <?php echo strip_tags((stripslashes($eventData['description']))); ?>
                                    </div>
                                 </div>
                              </div>
                              <?php } ?>
				  ...
				  <style>
				  h2, h3, h4, h5{font-size:18px !important; font-weight: 600 !important; padding-top:10px !important;}
				  hr{padding: 10px !important;}
				  p{ line-height:23px !Important;}
				  ul{padding-left: 20px !Important; padding-top: 10px !Important;}
				  .termscss table{border:1px solid #000 !Important; margin-top:10px !Important;}
				  .termscss table tr{border:1px solid #000 !Important;}
				  .termscss table tr td{border:1px solid #000 !Important; padding:10px !Important;}
				  .termscss table tr th{border:1px solid #000 !Important; padding:10px !Important;background-color: #000000 !Important; color: #fff !Important;}
				  </style>
				  
                  <?php $rsa=GetPageRecord('*','sys_PackageTips',' packageId="'.$rest['id'].'"   order by id asc');
                     while($listdataterm=mysqli_fetch_array($rsa)){ ?>
                  <div class="card" style="border: 0px;box-shadow: 0px 10px 18px #29426917;">
                     <div class="card-body termscss">
                        <h5 id="scroll-amenities" class="font-size-21 font-weight-bold text-dark mb-1"> 
                           <?php echo stripslashes($listdataterm['title']); ?>
                        </h5>
                        <?php echo (stripslashes($listdataterm['description'])); ?>
                     </div>
                  </div>
                  <?php  } ?>
               </div>
               <div class="col-4" style="padding-right: 0px;">
                  <div class="card" style="border: 0px;box-shadow: 0px 10px 18px #29426917; background-color:#ffe8a4;">
                     <div class="card-header" style="text-align:center; padding:15px;">
                        ...
                        <div style="font-size:11px; color:var(--bs-light);">Provide Your Details to Know Best Holiday Deals</div>
                     </div>
                  <div class="card-body" style="padding:20px;background: var(--bs-card-bg);" id="showflightbookingcancelaltion">
                        <form action="<?php echo $fullurl; ?>frmaction.html" method="post">
                           <div class="row">
                              <div class="col-sm-12 mb-3">
                                 <div class="filedlable">Destination</div>
                                 <input  type="text" class="form-control" name="citydestination" value="<?php echo stripslashes($rest['destinations']); ?>" autocomplete="nope" style="font-size:13px;"  placeholder="Destination Name"  required="required" readonly="">
                              </div>
                              <div class="col-sm-12 mb-3">
                                 <div class="filedlable">City of Departure</div>
                                 <select name="departureCity" class="form-control" id="departurecity" tabindex="2" placeholder="City of Departure" required="">
                              ...
                              <div class="col-sm-12 mb-3">
                                 ...
                                 <input  type="text" name="departuredate" class="form-control" readonly="" id="departuredate" value="<?php echo date('d-m-Y',strtotime('+ 7 days')); ?>" autocomplete="nope" style="font-size:13px;">
                              </div>
                              <div style=" font-size:16px; margin-bottom:10px; margin-top:0px;  "><strong>Contact Details</strong></div>
                              <div class="col-sm-6 mb-3">
                                 <input name="name" type="text" class="form-control" id="name" minlength="3" maxlength="50" placeholder="Type your full name" required="required">
                              </div>
                              <div class="col-sm-6 mb-3"> 
                                 <input class="form-control" type="text" name="email" id="email" placeholder="Type your email" required="required"> 
                              </div>
                              ...
                              <div class="col-sm-9 mb-3"> 
                                 <input class="form-control" type="text" name="mobile" id="mobile" maxlength="10" pattern="[0-9]{10}" placeholder="Type your mobile number" required="required">
                              </div>
                              
                              <div class="col-sm-4 mb-3"> 
                                 <input class="form-control"  type="number" name="adult" placeholder="Adult" required="required"  value=""> 
                              </div>
                              <div class="col-sm-4 mb-3"> 
                                 <input class="form-control" type="number" name="child" placeholder="Child" required="required" value="">
                              </div>
                              <div class="col-sm-4 mb-3"> 
                                 <input class="form-control" type="number" name="infant" placeholder="Infant" required="required" value="">
								 <input type="text" name="companyname" style="display:none !important" tabindex="-1" autocomplete="off">
                              </div>
                              <div class="col-sm-12 mb-3"> 
                                 <textarea name="remarks" class="form-control" cols="" rows="5" placeholder="Remarks"></textarea>
                              </div>
                             <div class="col-sm-4 mb-3" id="otpSection" style="display:none;">
                                 <input type="text"  id="email_otp" class="form-control" placeholder="Enter OTP" required="required" style="text-align:center;">
                              </div>
                              ...
                              <div class="col-sm-12 mb-0"> 
                                 ...
                                 <button type="submit" id="submitBtn" class="btn btn-danger cbtn-clr" disabled style="width: 100%; padding:10px 0px; text-align:center;">Submit</button>
                              </div>
                           </div>
                        </form>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                           <tr>
                              ...
                              <td width="90%" align="left" valign="top" style="padding-left:20px;">
                                 ...
                                 <div style="margin-bottom:2px; margin-top:10px;"><i class="fa fa-phone" aria-hidden="true"></i> <?php echo $companyProfileData['invoicePhone']; ?></div>
                                 <i class="fa fa-envelope" aria-hidden="true"></i> <a href="mailto:holidays@chalofly.com">holidays@chalofly.com</a>	
                              </td>
                           </tr>
                        </table>
                     </div>
      ...
      <?php echo $rest['bodyScript']; ?>
      <?php echo $rest['footerScript']; ?>
