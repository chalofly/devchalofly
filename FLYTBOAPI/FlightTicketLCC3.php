...
$req=file_put_contents("FLYTBOJSON/TicketLCCReq3.txt","$req");

$postdata = file_get_contents("FLYTBOJSON/TicketLCCReq3.txt","$req"); //Take JSON input from Postman Client
...
$results=file_put_contents("FLYTBOJSON/TicketLCCRes3.txt","$flightRes");
