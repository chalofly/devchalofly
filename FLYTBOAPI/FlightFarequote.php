...
$req=file_put_contents("FLYTBOJSON/".$agentId."_TBOFarequoteRequest_".date("Y-m-d_H:i:s").".txt","$postdata");
...
$results=file_put_contents("FLYTBOJSON/".$agentId."_TBOFarequoteResponse_".date("Y-m-d_H:i:s").".txt", $flightRes);
