...
$req=file_put_contents("FLYTBOJSON/".$tboBookingId."_TBOTicketRequest.txt","$req");
  
$postdata = file_get_contents("FLYTBOJSON/".$tboBookingId."_TBOTicketRequest.txt","$req"); //Take JSON input from Postman Client
//echo $postdata;
...
$results=file_put_contents("FLYTBOJSON/".$tboBookingId."_TBOTicketResponse.txt","$flightRes");
