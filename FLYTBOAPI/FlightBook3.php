...
$req=file_put_contents("FLYTBOJSON/BookReq3.txt","$req");
  
$postdata = file_get_contents("FLYTBOJSON/BookReq3.txt","$req"); //Take JSON input from Postman Client
...
$results=file_put_contents("FLYTBOJSON/BookRes3.txt","$flightRes");
