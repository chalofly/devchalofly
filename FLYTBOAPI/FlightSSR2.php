...
$req2=file_put_contents("FLYTBOJSON/".$agentId."_TBOSsrRequest_".date("Y-m-d_H:i:s").".txt","$req2");
...
$results2=file_put_contents("FLYTBOJSON/".$agentId."_TBOSsrResponse_".date("Y-m-d_H:i:s").".txt","$flightRes2");
