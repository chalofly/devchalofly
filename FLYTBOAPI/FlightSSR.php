...
$req=file_put_contents("FLYTBOJSON/".$agentId."_TBOSsrRequest_".date("Y-m-d_H:i:s").".txt","$postdata");
...
$results=file_put_contents("FLYTBOJSON/".$agentId."_TBOSsrReqSsrResponse_".date("Y-m-d_H:i:s").".txt","$flightRes");
