...
$req=file_put_contents("FLYTBOJSON/".$agentId."_TBOFareRuleOBRequest_".date("Y-m-d_H:i:s").".txt","$req");
  
$postdata = file_get_contents("FLYTBOJSON/".$agentId."_TBOFareRuleOBRequest_".date("Y-m-d_H:i:s").".txt","$req"); //Take JSON input from Postman Client
//echo $postdata;
...
$results=file_put_contents("FLYTBOJSON/".$agentId."_TBOFareRuleOBResponse_".date("Y-m-d_H:i:s").".txt","$flightRes");
