...
$req=file_put_contents("FLYTBOJSON/".$agentId."_TBOSsrIBRequest_".date("Y-m-d_H:i:s").".txt","$req");
  
$postdata = file_get_contents("FLYTBOJSON/".$agentId."_TBOSsrIBRequest_".date("Y-m-d_H:i:s").".txt","$req"); //Take JSON input from Postman Client
//echo $postdata;
...
$resultsR=file_put_contents("FLYTBOJSON/".$agentId."_TBOSsrIBResponse_".date("Y-m-d_H:i:s").".txt","$flightResR");
