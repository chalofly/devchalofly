...
$req=file_put_contents("FLYTBOJSON/".$agentId."_TBOFarequoteIBRequest_".date("Y-m-d_H:i:s").".txt","$req");
  
$postdata = file_get_contents("FLYTBOJSON/".$agentId."_FlyShopFarequoteIBRequest_".date("Y-m-d_H:i:s").".txt","$req"); //Take JSON input from Postman Client
...
$results=file_put_contents("FLYTBOJSON/".$agentId."_TBOFarequoteIBResponse_".date("Y-m-d_H:i:s").".txt","$flightRes");
