...
$b=GetPageRecord('*','wig_flight_json_bkp','  uniqueSessionId="'.$_SESSION['uniqueSessionId'].'"  and FLIGHT_NO="'.$res['FLIGHT_NO'].'" and DEP_TIME="'.$res['DEP_TIME'].'" and FLIGHT_CODE="'.$res['FLIGHT_CODE'].'" order by AMT asc  ');
...
<a id="booknowlink<?php echo stripslashes($res['id']); ?>" onclick="loadmoreflight('<?php echo stripslashes($res['id']); ?>','<?php echo $res['FLIGHT_NO']; ?>','<?php echo $res['DEP_TIME']; ?>','<?php echo $res['FLIGHT_CODE']; ?>');" style="cursor:pointer;"><button type="button" class="btn fbtn-danger" style="width:100%;"  >Select <i class="fa fa-angle-down" aria-hidden="true"></i></button></a>
</div>
 ...
 */       
  ...
  <tr>
	...
	<div style="line-height: 0px;    line-height: 14px;">
	    <!---
	<input type="checkbox" id="toggle<?php echo stripslashes($flightprice['id']); ?>">
	Show/Hide Net Fare
	-->
	<span class="netpriceshow" id="netpriceshowspan<?php echo stripslashes($flightprice['id']); ?>" style="  width:100%; color:#009933;">&#8377; <?php
	...
	$totaltdsdisplay=round($flightprice['acom']*5/100);
	 ...
	 echo $flightprice['acom']; ?></span>	</span><?php } ?></div>
	   </td>
   ...
   <div class="flhtext"><div class="blackbox" style="margin-left:0px;">
						...
						<div class="" style="background-color: <?php echo $flightprice['PCC']; ?>;"> <?php echo $flightprice['FARE_TYPE']; ?></div>
					<?php } ?></div></div></td>
...
$("#toggle<?php echo stripslashes($flightprice['id']); ?>").change(function() {
	...
	Show/Hide Net Fare
	-->
	<div style="line-height: 0px;line-height: 14px;"><span class="netpriceshow" id="netpriceshowspan<?php echo stripslashes($flightprice['id']); ?>" style="width:100%; color:#009933;">&#8377; <?php
	$totaltdsdisplay=0;
	$totaltdsdisplay=round($flightprice['acom']*5/100);
	echo ($flightprice['netFareBeforecomm']+$totaltdsdisplay); ?> - <span >Earn. &#8377;<?php
	echo $flightprice['acom']; ?></span></span></div>
