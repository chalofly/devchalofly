...
<style>
  #midbody{padding-top: 70px;}
  #dashbaordright .inlistright{padding-top: 70px;}
  #dashbaordright .inlistright .rightbanner img{margin-top: 30px;}
  #leftsidemenu .inlist .companyinfobox{margin-top: 25px;}
