...
//exit();
 ...
 echo $namevalue ='name="'.addslashes($_POST['name']).'",mobile="'.addslashes($_POST['mobile']).'",email="'.addslashes($_POST['email']).'",packageName="'.addslashes($_POST['packageName']).'",citydestination="'.addslashes($_POST['citydestination']).'",departureCity="'.addslashes($_POST['departureCity']).'",departureDate="'.date('Y-m-d',strtotime($_POST['departuredate'])).'",addDate="'.date('Y-m-d H:i:s').'",agentId="'.$_SESSION['agentUserid'].'"';  

 $bookinglastId = addlistinggetlastid('packageEnquiry',$namevalue); 
 
 
/*  $namevaluequery ='name="'.addslashes($_POST['name']).'", phone="'.addslashes($_POST['mobile']).'", email="'.addslashes($_POST['email']).'", destinationName="'.addslashes($_POST['citydestination']).'", departureCity="'.addslashes($_POST['departureCity']).'", departureDate="'.date('Y-m-d',strtotime($_POST['departuredate'])).'", addDate="'.date('Y-m-d H:i:s').'"';  

 $querybookinglastId = addlistinggetlastid('queryMaster',$namevaluequery); 
 
 $namevalueuser ='firstName="'.addslashes($_POST['name']).'", phone="'.addslashes($_POST['mobile']).'", email="'.addslashes($_POST['email']).'", destinationList="'.addslashes($_POST['citydestination']).'", addDate="'.date('Y-m-d H:i:s').'", userType="4"';  

 $userbookinglastId = addlistinggetlastid('userMaster',$namevalueuser); */
...
send_attachment_mail_new('jitesh@travbizz.com',$subject,$mailbody,$cc);
