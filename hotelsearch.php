...
.mobilehight{height: 360px !important;}
.top_bg_ofr_sb{display: none !important;}
#loadallhotels{margin-top: 70px !important;}
 }
...
<div class="top_bg_ofr_sb top_bg_ofr_sb2other homeflightsearchouterbox hotelmainbg mobilehight" style="margin-bottom: 90px;padding: 50px 0px;">
   
    
    <div class="container mobilecontainer" style="padding: 0px 20px; padding-top: 200px;">
    <h1 class="hotelheading" style="text-align:center;margin-top: 20px;margin-bottom: 0px;">Cheapest Price. Guaranteed!</h1>
